# Импортируем нужные библиотеки из всего 4
...
folder_path = "C:\\Users\\HP\\Desktop\\check\\grid_dict"
...
file_path_test = "C:\\Users\\HP\\Desktop\\check\\data\\test.json"
...
print('Магия произошла, вот предсказанный пол для первых 5 человек:')

print(df_check_test.head())

print('Записываем данные о предсказанном поле')
df_check_test.to_csv('predict_result.csv', index=False)
